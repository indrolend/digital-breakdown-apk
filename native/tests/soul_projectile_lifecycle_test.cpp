...
int main(){
    bool ok=true;
    float wallVelocityX=0.0f,ceilingVelocityY=0.0f,meleeSpeed=0.0f,lungeSpeed=0.0f;
    int recoveredSouls=0;
    std::uint64_t recoveredSoulId=0,replayAId=0,replayBId=0;
    {
    ...
    }
    {
        ...
        meleeSpeed=speed(mb.vel);
        ok&=meleeHits==1&&mb.vel.z<0&&mb.vel.y>0&&meleeSpeed>22.0f&&meleeSpeed<26.0f&&mb.contactCooldown>0;
    }
    {
        ...
        lungeSpeed=speed(lb.vel);
        ok&=lungeHits==1&&lb.vel.z<0&&lb.vel.y>0&&lungeSpeed>33.0f&&ls.hud.criticalHitPulse>0.9f;
    }
    {
    ...
    }
    {
        ...
        recoveredSouls=rs.player.souls;recoveredSoulId=rs.player.storedSouls[0].id;
    }
    {
        ...
        replayAId=a.soul.id;replayBId=b.soul.id;
    }
    {
