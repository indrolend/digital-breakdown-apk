...
int main(){
    ...
    in.leftFootPosition=body.leftFootPlant; in.rightFootPosition=body.rightFootPlant;
    in.leftFootLoad=1.0f; in.rightFootLoad=1.0f;
    in.correctiveStepActive=true; in.recoveryUrgency=0.8f;
    ...
    in.correctiveStepActive=false; in.recoveryUrgency=0.0f;
