...
inline RoomLightingProfile roomLightingProfile(early_browser_visuals::RoomSetting setting,early_browser_visuals::RoomForm form,int roomSeed,int roomIndex,float time,float phonePower){
    ...
    switch(setting){
        case RoomSetting::Field:
            profile={{0.42f,0.55f,0.61f},{0.76f,0.75f,0.66f},{0.24f,0.27f,0.23f},{0.96f,0.84f,0.68f},{-18.0f,50.0f,12.0f},{0.16f,0.22f,0.25f},{20.0f,25.0f,-30.0f},{},{0.60f,0.63f,0.58f},0.010f,PrimaryLightSource::OutdoorSun};break;
        ...
        case RoomSetting::City:
            profile={{0.16f,0.18f,0.20f},{0.50f,0.47f,0.40f},{0.12f,0.12f,0.13f},{0.74f,0.69f,0.58f},{-12.0f,50.0f,-8.0f},{0.11f,0.14f,0.18f},{18.0f,24.0f,-28.0f},{},{0.30f,0.29f,0.27f},form==early_browser_visuals::RoomForm::Canyon?0.022f:0.017f,PrimaryLightSource::UrbanSky};break;
        case RoomSetting::Coastal:
            profile={{0.40f,0.57f,0.63f},{0.82f,0.78f,0.65f},{0.22f,0.26f,0.25f},{0.98f,0.86f,0.68f},{-16.0f,48.0f,10.0f},{0.15f,0.24f,0.28f},{20.0f,25.0f,-30.0f},{},{0.65f,0.68f,0.61f},0.014f,PrimaryLightSource::OutdoorSun};break;
    }
