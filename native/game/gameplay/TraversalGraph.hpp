...
inline const char* traversalRoleName(TraversalRole role){switch(role){case TraversalRole::Required:return "REQUIRED";case TraversalRole::Optional:return "OPTIONAL";}return "REQUIRED";}
