...
function updateGamepadDiagnostics() {
  ...
  if (now - gamepadDiag.lastLogTime > 1500) {
    console.log(
      ...
      gamepadDiag.id,
      "LXLY",
      gamepadDiag.lx.toFixed(2),
      gamepadDiag.ly.toFixed(2),
      "RXRY",
      gamepadDiag.rx.toFixed(2),
      gamepadDiag.ry.toFixed(2)
    );
...
function updateCamera(dt) {
  ...
  if (input.padLookX !== 0 || input.padLookY !== 0) {
    ...
    input.last = "pad-look:" + input.padLookX.toFixed(1) + "," + input.padLookY.toFixed(1);
  }
