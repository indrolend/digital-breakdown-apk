...
| --- | --- | --- | --- |
| Phone model | `native-models/phone.dbmesh` | Project-owned, generated original DATA reconstruction device. | Deterministically generated by `tools/pass7-oracle/generate-native-models.mjs`; does not use the embedded iPhone geometry. |
