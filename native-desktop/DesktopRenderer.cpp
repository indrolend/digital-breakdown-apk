...
void DesktopRenderer::draw(const GameState& state) const {
    ...
    glPushMatrix();glMultMatrixf(shadowMatrix);
    ...
    // Room-scale colliders remain excluded from projected shadows.
    }
